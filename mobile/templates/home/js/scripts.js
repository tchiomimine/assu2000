...
jQuery(document).ready(function($){
	...
	if (readCookie('utilisateurConnecte') == 'yes') {
		...
		var result = loc.indexOf('Proximeo');
		if (result>0) {
			$('#Espace_personnel').html('<a class="espaceperso" href="/Proximeo/deconnexion.do">Se déconnecter <span id="contact_picto"></span></a>');
			$('li.item1279 a').attr("href", "/Proximeo/deconnexion.do");
		}else{
			$('#Espace_personnel').html('<a class="espaceperso" href="/Proximeo/accueil.do">Connecté <span id="contact_picto"></span></a>');
