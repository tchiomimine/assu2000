...
t.popuptheme=text;if(!auto){t.auto();auto=true;}}}).send(JCEMediaBox.site+JCEMediaBox.options.themepath+'/'+theme+'/popup.html');}},open:function(data,title,group,type,params){var i,o={};if(typeof data=='string'){data={'src':data,'title':title,'group':group,'type':type,'params':params};}
