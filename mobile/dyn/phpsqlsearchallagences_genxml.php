...
$query = sprintf("SELECT ADRESSE_AGENCE, CP_AGENCE, VILLE_AGENCE, LIB_AGENCE, RSP_NOM_AGENCE, TEL_AGENCE, LATITUDE_AGENCE, LONGITUDE_AGENCE, m.alias AS url FROM fra2_data".$suffix.".dlpx8_agences a inner join fra2_data".$suffix.".dlpx8_coordonnees_gps_agences b on a.ID_AGENCE=b.ID_AGENCE LEFT JOIN dlpx8_agences_menu am ON (a.ID_AGENCE = am.agence_id) LEFT JOIN dlpx8_menu m ON am.menu_id=m.id WHERE LATITUDE_AGENCE IS NOT NULL
AND LONGITUDE_AGENCE IS NOT NULL ORDER BY LIB_AGENCE");
